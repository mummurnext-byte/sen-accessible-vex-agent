...
- [ ] The first lesson is appropriate for complete beginners aged 8-14.
- [ ] Sen's English narration sounds natural and age-appropriate.
- [ ] The `INPUT -> BRAIN -> OUTPUT` model is clear.
- [ ] The English and Thai materials match the intended classroom use.
- [ ] The visual style is sufficiently minimal and high contrast.
- [ ] The Facebook positioning matches the open accessible robotics project.
- [ ] Requested revisions have been written below.
...
`VIDEO_APPROVED by __________ on YYYY-MM-DD`
